...
#include "UnrealGameOffroadCar.h"
#include "UnrealGameOffroadWheelFront.h"
#include "UnrealGameOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AUnrealGameOffroadCar::AUnrealGameOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UUnrealGameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UUnrealGameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UUnrealGameOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UUnrealGameOffroadWheelRear::StaticClass();
