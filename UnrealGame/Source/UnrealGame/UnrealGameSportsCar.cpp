...
#include "UnrealGameSportsCar.h"
#include "UnrealGameSportsWheelFront.h"
#include "UnrealGameSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AUnrealGameSportsCar::AUnrealGameSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UUnrealGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UUnrealGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UUnrealGameSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UUnrealGameSportsWheelRear::StaticClass();
